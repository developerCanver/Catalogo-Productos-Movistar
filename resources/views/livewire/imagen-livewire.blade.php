        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" wire:model="titulo" class="form-control" placeholder="Pepito">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" wire:model="imagen" placeholder="Pepito@gmail.com">
                </div>
                            ...
                            <tr>
                                <td class="border px-4 py-2">
                                    <input type="checkbox" wire:model="eliminarselect" onclick="myFunction()" name="chk"
                                        id="myCheck" value="{{$consulta->id_imagen}}">
                                </td>
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" wire:model="imagen">
