                    ...
                    <div class="form-group ">
                        ...
                        <div class="mb-3">
                            <div class="custom-control custom-radio">
                                <input type="radio" id="customRadio1" name="animal" wire:model="status" value="on"
                                    class="custom-control-input" checked>
                                <label class="custom-control-label text-xs" for="customRadio1">Activo</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="customRadio2" wire:model="status" name="animal" value="off"
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="/img/users/{{$consulta->imagen}}" style="max-width:150px;"
                                            alt="user-image" class=""></td>
                                    ...
                                    <form>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="mb-3">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="customRadio1" name="animal"
                                                            wire:model="status" value="on" class="custom-control-input"
                                                            checked>
                                                        <label class="custom-control-label text-xs"
                                                            for="customRadio1">Activo</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="customRadio2" wire:model="status"
                                                            name="animal" value="off" class="custom-control-input">
                                                        <label class="custom-control-label text-xs"
                                                            for="customRadio2">Desactivada</label>
                                                    </div>
                                                </div>
                                                @error('status') <span
                                                    class="text-danger">{{ $message }}</span>@enderror
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" style="background: #ffffff;color:#1a2942;"
                                                wire:click.prevent="cancelar()" class="btn btn-secondary"
                                                data-dismiss="modal">Cerrar</button>
                                            <button type="button"
                                                wire:click.prevent="update({{ $consulta->id_imagen }})"
